...
class TodoListViewController: UIViewController, TodoDetailViewControllerDelegate {
    typealias EditingStatus = (isEditingMode: Bool, cell: UITableViewCell?, textView: UITextView?, indexPath: IndexPath?)
    ...
    var editingStatus: EditingStatus = (false, nil, nil, nil) {
        didSet(oldValue) {
